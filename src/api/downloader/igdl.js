    ...
    try {
        ...
        return {
            ...
            metadata: {
                ...
                like: formatShortNumber(mediaData.edge_media_preview_like.count),
                comment: formatShortNumber(mediaData.edge_media_to_comment.count),
...
module.exports = function (app) {
    app.get('/download/instagram', async (req, res) => {
        ...
        try {
            const result = await Instagram(query);
            ...
            const responseData = {
                download_urls: Array.isArray(result.url) ? result.url : [result.url],
